...
def welcome_assignment_answers(question):
    ...
    if question == "What is the secret passphrase posted in the #lab-python-getting-started channel posted by a TA? - string":
        answer = "mtls"
...
# ##"What is the MD5 hashing value to the following message: 'NYU Computer Networking' - Use MD5 hash generator and use
